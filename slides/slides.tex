...
\item Aún así, {\bf características comunes}:
  \begin{itemize}
  \item No se basan en SQL
  \item {\bf Escalabilidad}
  \item Generalmente no obligan a definir un esquema ({\itshape\bfseries
      schemaless})
\item Surgidos de la comunidad para solucionar problemas, y muchas de
  ellas son {\bf libres/{\itshape open source}}
\item Diseño basado en procesamiento distribuido
\item Aplican tecnologías funcionales como {\bf MapReduce}
\end{itemize}
\end{itemize}
\framebreak
