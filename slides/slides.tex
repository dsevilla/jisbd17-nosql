...
La construcción \verb|$lookup| permite el acceso a otra colección. Es
equivalente a un {\bf JOIN}.

\begin{block}{}
  \begin{itemize}
  \item Imaginemos otra colección {\bf Conferences}, donde listo las
    conferencias a las que he ido
  \item xx
  \end{itemize}
\end{block}
